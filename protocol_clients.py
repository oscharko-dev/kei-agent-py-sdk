...
from .exceptions import ProtocolError, CommunicationError, TimeoutError
...
class KEIRPCClient(BaseProtocolClient):
    ...
    async def _rpc_call(self, method: str, params: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            raise ProtocolError(f"RPC-Call fehlgeschlagen: {e.response.status_code}") from e
...
class KEIBusClient(BaseProtocolClient):
    ...
    async def publish(self, message: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            raise ProtocolError(f"Bus-Publish fehlgeschlagen: {e.response.status_code}") from e
        except httpx.RequestError as e:
    ...
    async def subscribe(self, topic: str, agent_id: str) -> Dict[str, Any]:
        ...
        try:
            ...
            raise ProtocolError(f"Bus-Subscribe fehlgeschlagen: {e.response.status_code}") from e
        except httpx.RequestError as e:
...
class KEIMCPClient(BaseProtocolClient):
    ...
    async def discover_tools(self, category: Optional[str] = None) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            raise ProtocolError(f"MCP-Tool-Discovery fehlgeschlagen: {e.response.status_code}") from e
        except httpx.RequestError as e:
    ...
    async def use_tool(self, tool_name: str, parameters: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            raise ProtocolError(f"MCP-Tool-Execution fehlgeschlagen: {e.response.status_code}") from e
        except httpx.RequestError as e:
