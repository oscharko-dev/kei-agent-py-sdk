...
class SecurityConfigValidation(BaseValidationModel):
    ...
    tls_pinned_sha256: Optional[str] = Field(None, description="Pinned certificate SHA-256 fingerprint")
    ...
    def validate_api_token(cls, v):
        ...
        placeholder_patterns = [
            'your-', 'test-', 'example-', 'placeholder', 'dummy', 'fake'
        ]
...
class ProtocolConfigValidation(BaseValidationModel):
    ...
    max_connections_per_protocol: int = Field(
        ...
        ge=1,
        le=100,
        description="Maximum connections per protocol"
    )
